...
;(function () {
  ...
  `
    ...
    let settings = {
      ...
      names: ['native', 'last-space', 'first-space'].find(v => v === localStorage.getItem('gmgv-names')) || 'native',
    }
        ...
        toggleButton.innerHTML = `
          ...
          <div>
            ...
            <div class="__gmgv-source-code">
              ...
              <a href="https://github.com/AidanGamer594/Galaxy-OS" target="_blank">${T('sourceCode')}</a>
            </div>
            ${
              authorized
                ? ''
                : `
            <hr>
            <a href="https://github.com/AidanGamer594/Galaxy-OS" target="_blank">${T('unauthorizedWarning')}</a>
            `
            }
          </div>
        `
