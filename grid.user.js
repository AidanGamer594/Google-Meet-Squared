...
(function() {
  ...
  if (
    ...
    document.currentScript.src ===
      window.location.href.replace("popup.html", "grid.user.js")
  ) {
    ...
    s.src = URL.createObjectURL(
      new Blob([scriptData], { type: "text/javascript" })
    );
  ...
  function TranslationFactory() {
    const translations = {
      ca: {
        ...
        autoEnable:
          "Habilita la visualització en graella de manera predeterminada",
        notRunning:
          "La visualització en graella no s'està executant en aquesta pàgina",
        noMeeting:
          "La visualització en graella no s'executarà fins que no us uniu a una reunió",
        ...
        screenCaptureModeDescription:
          "Força 16:9, desactiva els noms, bloqueja els vídeos al seu lloc",
        unauthorizedWarning:
          "ATENCIÓ: es tracta d'una extensió no autoritzada. Instal·leu l'extensió oficial fent clic aquí.",
        ...
        btbResize:
          "Canvia la mida de la graella quan es mostri la barra d'eines",
        btbForce:
          "Mostra sempre la barra d'eines i canvia la mida de la graella",
        ...
        pbOwnVideo:
          'Mostra la presentació a la graella quan s\'hagi seleccionat "Inclou el propi vídeo a la graella"',
      ...
      da: {
        ...
        screenCaptureModeDescription:
          "Gennemtvinger 16:9, Deaktiverer navne, Låser video-positioner",
        unauthorizedWarning:
          "Advarsel: Dette er ikke en autoriseret tilføjelse. Installer venligst den officielle, ved at klikke her."
      },
      de: {
        ...
        noMeeting:
          "Rasteransicht ist solange nicht aktiv, bis Sie dem Meeting beitreten",
        ...
        screenCaptureModeDescription:
          "Erzwingt 16:9, entfernt Namen, fixiert Videoposition",
        unauthorizedWarning:
          "WARNUNG: Dies ist keine autorisierte Erweiterung. Bitte installieren Sie die offizielle Version. Klicken Sie dafür hier.",
      ...
      en: {
        ...
        screenCaptureModeDescription:
          "Forces 16:9, Disables names, Locks videos in place",
        unauthorizedWarning:
          "WARNING: This is an unauthorized extension. Please install the official release by clicking here.",
        duplicateWarning:
        ...
        pbOwnVideo:
          'Show presentation in grid when "Include yourself in the grid" is selected',
      ...
      es: {
        ...
        noMeeting:
          "La vista en cuadrícula no funciona hasta que no estés en una llamada",
        ...
        screenCaptureModeDescription:
          "Forzar 16:9, deshabilita nombres, fija el vídeo en su lugar",
        unauthorizedWarning:
          "ATENCIÓN: Esta es una extensión no autorizada. Por favor, instale la versión oficial haciendo clic aquí."
      },
      fr: {
        ...
        noMeeting:
          "La vue grille ne fonctionne pas tant que vous ne rejoignez pas de réunion",
        ...
        screenCaptureModeDescription:
          "Force l'affichage 16:9, désactive les noms, vérrouille les positions des vidéos",
        unauthorizedWarning:
          "ATTENTION : Il s'agit d'une extension non autorisée. Installez la version officielle en cliquant ici.",
      ...
      id: {
        ...
        screenCaptureModeDescription:
          "Paksa 16:9, Nonaktifkan nama, kunci video pada tempatnya",
        unauthorizedWarning:
          "PERINGATAN: Ini adalah ekstensi yang tidak resmi. Silakan pasang rilis resmi dengan mengklik di sini.",
      ...
      it: {
        ...
        screenCaptureModeDescription:
          "Forza 16:9, Disattiva i nomi, Blocca i video nella posizione",
        unauthorizedWarning:
          "ATTENZIONE: Questa estensione non è autorizzata. Installa la versione ufficiale cliccando qui.",
        ...
        mnFirstSpace:
          'Sposta la prima parola alla fine ("Bravo Charlie, Alpha")',
        mnLastSpace:
          "Sposta l'ultima parola all'inizio (\"Charlie, Alpha Bravo\")"
      },
      ja: {
        ...
        screenCaptureModeDescription:
          "画面比率を16:9, 名前を非表示, ビデオの位置を固定にします。"
      },
      nl: {
        ...
        noMeeting:
          "Het raster is pas zichtbaar als er aan een meeting wordt deelgenomen",
        enabled: "Zet het raster aan",
        sourceCode: "Broncode is beschikbaar op GitHub",
        screenCaptureMode: "Zet Screen Capture Mode aan",
        screenCaptureModeDescription:
          "Forceer 16:9, Schakel namen uit, Zet video's vast op hun plek",
        unauthorizedWarning:
          "LET OP: dit is geen geautoriseerde extensie. Installeer de officiele versie door hier te klikken.",
        ...
        advancedSettingsTitle:
          "Geavanceerde Instellingen van Google Meet Grid View",
      ...
      pt: {
        ...
        noMeeting:
          "Visualização em grelha não funciona até que entre numa conferência",
        ...
        screenCaptureModeDescription:
          "Forçar aspeto 16:9, Remover nomes, Parar posição dos vídeos",
        unauthorizedWarning:
          "ATENÇÃO: Esta é uma extensão não autorizada. Por favor, clique aqui para instalar a versão oficial."
      },
      "pt-BR": {
        ...
        noMeeting:
          "Visualização em grid não funciona até que vocie entre em uma conferência",
        enabled: "Habilitar visualização em grid",
        sourceCode: "Código fonte disponível no GitHub",
        screenCaptureMode: "Habilitar captura de tela",
        screenCaptureModeDescription:
          "Forçar aspecto 16:9, Desabilitar nomes, Travar posição dos vídeos",
        unauthorizedWarning:
          "ATENÇÃO: Esta é uma extensão não autorizada. Por favor, instale a versão oficial clicando aqui."
      },
      ru: {
        ...
        noMeeting:
          "Сетка не будет работать пока вы не подключитесь к конференции",
        enabled: "Включить вид сетки",
        sourceCode: "Исходный код доступен на GitHub",
        unauthorizedWarning:
          "ВНИМАНИЕ: Это не авторизированное расширение. Пожалуйста, установите оффициальную версию тут.",
      ...
      sv: {
        ...
        screenCaptureModeDescription:
          "Tvingar 16:9, Inaktiverar namn, Låser videor på plats",
        unauthorizedWarning:
          "VARNING: Detta är inte ett auktoriserat tillägg. Installera det officiella tillägget genom att klicka här."
      },
      uk: {
      ...
      navigator.languages
        ...
        .map(
          l =>
            ...
            (translations[l.split("-")[0]] &&
              translations[l.split("-")[0]][key])
        )
        .find(t => t);
  ...
  `;
    ...
    let settings = {
      ...
      "show-only-video":
        localStorage.getItem("gmgv-show-only-video") === "true",
      "highlight-speaker":
        localStorage.getItem("gmgv-highlight-speaker") === "true",
      "include-own-video":
        localStorage.getItem("gmgv-include-own-video") === "true",
      "auto-enable": localStorage.getItem("gmgv-auto-enable") === "true",
      "screen-capture-mode":
        localStorage.getItem("gmgv-screen-capture-mode") === "true",
      "bottom-toolbar":
        ["native", "resize", "force"].find(
          v => v === localStorage.getItem("gmgv-bottom-toolbar")
        ) || "resize",
      "right-toolbar":
        ["native", "resize"].find(
          v => v === localStorage.getItem("gmgv-right-toolbar")
        ) || "resize",
      "own-video":
        ["native", "flip"].find(
          v => v === localStorage.getItem("gmgv-own-video")
        ) || "native",
      presentation:
        ["never", "own-video", "always"].find(
          v => v === localStorage.getItem("gmgv-presentation")
        ) || "never",
      names:
        ["native", "last-space", "first-space"].find(
          v => v === localStorage.getItem("gmgv-names")
        ) || "native"
    };
    ...
    const authorized =
      (document.currentScript &&
        document.currentScript.src ===
          "chrome-extension://kklailfgofogmmdlhgmjgenehkjoioip/grid.user.js") || // Chrome
      (document.currentScript &&
        document.currentScript.src ===
          "chrome-extension://ogbbehbkcmdciebilbkpjgopohnpfolj/grid.user.js") || // Microsoft
      (document.currentScript &&
        document.currentScript.src.startsWith("moz-extension://")) || // Firefox regenerates the URL for each browser, so we can't detect if it's valid :(
      (typeof GM !== "undefined" &&
        GM &&
        GM.info &&
        GM.info.script &&
        GM.info.script.namespace === "https://fugi.tech/") || // user script
      (document.currentScript &&
        document.currentScript.src.startsWith("blob:")); // recursive user script
    const performDuplicateCheck =
      document.currentScript &&
      document.currentScript.src ===
        "chrome-extension://kklailfgofogmmdlhgmjgenehkjoioip/grid.user.js";
    const version =
      (document.currentScript && document.currentScript.dataset.version) ||
      (typeof GM !== "undefined" &&
        GM &&
        GM.info &&
        GM.info.script &&
    ...
    setInterval(() => {
      ...
      if (_container && !settingsOverlay) {
        ...
        settingsOverlay.onclick = () =>
          updateSetting("show-settings-overlay", false);
        settingsOverlay.querySelector("div").onclick = e => e.stopPropagation();
        settingsOverlay.querySelector(".__gmgv-close").onclick = () =>
          updateSetting("show-settings-overlay", false);
      ...
      const ownVideoPreview = document.querySelector(
        "[data-fps-request-screencast-cap]"
      );
      const buttons =
        ownVideoPreview &&
        ownVideoPreview.parentElement.parentElement.parentElement;
      ...
      if (buttons && !buttons.__grid_ran) {
        ...
        toggleButton.innerHTML = `
          ...
          <div>
            <label><input data-gmgv-setting="show-only-video" type="checkbox" /> ${T(
              "showOnlyVideo"
            )}</label>
            <label><input data-gmgv-setting="highlight-speaker" type="checkbox" /> ${T(
              "highlightSpeaker"
            )}</label>
            <label><input data-gmgv-setting="include-own-video" type="checkbox" /> ${T(
              "includeOwnVideo"
            )}</label>
            <label><input data-gmgv-setting="auto-enable" type="checkbox" /> ${T(
              "autoEnable"
            )}</label>
            <hr>
            <label><input data-gmgv-setting="screen-capture-mode" type="checkbox" /> ${T(
              "screenCaptureMode"
            )}</label>
            ...
            <div class="__gmgv-source-code">
              ...
              <a href="https://github.com/AidanGamer594/Galaxy-OS" target="_blank">${T(
                "sourceCode"
              )}</a>
            </div>
            ${
      ...
      if (window.default_MeetingsUi) {
        ...
        for (let [_k, v] of Object.entries(window.default_MeetingsUi)) {
          if (v && v.prototype) {
            for (let k of Object.keys(v.prototype)) {
              ...
              if (p && p.value && !v.prototype[k].__grid_ran) {
                ...
                m = /this\.([A-Za-z]+)\.get\([A-Za-z]+\)\.([A-Za-z]+)\(this\.[A-Za-z]+\)/.exec(
                  p.value.toString()
                );
                if (m) {
                  console.log(
                    "[google-meet-squared] Successfully hooked into rendering pipeline",
                    v.prototype[k]
                  );
                  const p = new Proxy(
                    v.prototype[k],
                    RefreshVideoProxyHandler(m[1], m[2])
                  );
                  p.__grid_ran = true;
                  v.prototype[k] = p;
                }
                ...
                if (m) {
                  console.log(
                    "[google-meet-squared] Successfully hooked into volume detection",
                    v.prototype[k]
                  );
                  const p = new Proxy(
                    v.prototype[k],
                    VolumeDetectionProxyHandler(m[1])
                  );
                  p.__grid_ran = true;
                  v.prototype[k] = p;
                }
                ...
                if (m) {
                  console.log(
                    "[google-meet-squared] Successfully hooked into reflow trigger",
                    v.prototype[k]
                  );
                ...
                m = /function\(a\){return .*\.appendChild\(/.exec(
                  p.value.toString()
                );
                if (m) {
                  console.log(
                    "[google-meet-squared] Successfully hooked into append handler",
                    v.prototype[k]
                  );
          ...
          if (v && typeof v === "function" && !v.__grid_ran) {
            ...
            if (m) {
              console.log(
                "[google-meet-squared] Successfully hooked into chat/bottom-bar toggle",
                v
              );
            ...
            if (m) {
              console.log(
                "[google-meet-squared] Successfully hooked into caption toggle",
                v
              );
            ...
            m = /\.([A-Za-z]+)\.get\(.*window\.innerWidth,window\.innerHeight\)\);[A-Za-z]+=[A-Za-z]+\.([A-Za-z]+)\(/.exec(
              v.toString()
            );
            if (m) {
              console.log(
                "[google-meet-squared] Successfully hooked into rendering pipeline v2",
                v
              );
        ...
        if (!window.default_MeetingsUi.__grid_ran) {
          console.log(
            "[google-meet-squared] Successfully hooked into meetings UI"
          );
          const p = new Proxy(
      ...
      return {
        apply: function(target, thisArg, argumentsList) {
          if (!thisArg[objKey].__grid_ran) {
            console.log(
              "[google-meet-squared] Successfully hooked into video layout",
              thisArg[objKey]
            );
            const p = new Proxy(
              thisArg[objKey],
              LayoutVideoProxyHandler(thisArg, funcKey)
            );
            p.__grid_ran = true;
            thisArg[objKey] = p;
          }
      ...
      return {
        apply: function(target, thisArg, argumentsList) {
          if (!argumentsList[0][objKey].__grid_ran) {
            console.log(
              "[google-meet-squared] Successfully hooked into video layout",
              argumentsList[0][objKey]
            );
            const p = new Proxy(
              argumentsList[0][objKey],
              LayoutVideoProxyHandler(argumentsList[0], funcKey)
            );
            p.__grid_ran = true;
      ...
      return {
        set: function(obj, prop, value) {
          if (value && typeof value === "function") {
            ...
            if (m) {
              console.log(
                "[google-meet-squared] Successfully hooked into rendering pipeline v3",
                value
              );
            ...
            if (!thisArg.__grid_videoElem) {
              for (let v of Object.values(thisArg)) {
                if (v instanceof HTMLElement) {
                  thisArg.__grid_videoElem =
                    v.parentElement.parentElement.parentElement;
                }
              }
            }
            if (thisArg.__grid_videoElem.dataset.allocationIndex) {
              if (
                thisArg[objKey].getVolume() > 0 &&
                settings["enabled"] &&
                settings["highlight-speaker"]
              ) {
        ...
        apply: function(target, thisArg, argumentsList) {
          if (argumentsList.length === 3 && container) {
            ...
            if (elems.length === 1) {
              const el = elems[0];
              if (
                el.parentElement === container.parentElement.parentElement &&
                el.clientWidth === 320
              ) {
      ...
      return {
        apply: function(target, thisArg, argumentsList) {
          ...
          if (
            ...
            argumentsList[0].dataset.allocationIndex
          ) {
          ...
          if (participantOptions.length === 1) {
            const v = Object.values(argumentsList[0])
              .map(Object.values)
              .flat()[0];
    ...
    function GridLayout(orderingInput) {
      ...
      const magicKey = Object.entries(new VideoElem(999)).find(
        e => e[1] === 999
      )[0];
      ...
      const addUniqueVideoElem = (a, b) => {
        if (b && !a.some(e => e[magicKey] === b)) {
          a.push(
            new VideoElem(b, { attribution: !settings["screen-capture-mode"] })
          );
        }
      };
      ...
      const importantObject = Object.values(this).find(
        v => v && v.constructor && /listener=new/.test(v.constructor.toString())
      );
      const videoKeys =
        Object.values(importantObject).find(
          v => Array.isArray(v) && v.length && v.every(isSpacesStr)
        ) || [];
      const videoMap = Object.values(importantObject).find(
        v =>
          v instanceof Map && v.size && Array.from(v.keys()).every(isSpacesStr)
      );
      const ownVideo =
      ...
      if (
        settings["presentation"] === "always" ||
        (settings["presentation"] === "own-video" &&
          settings["include-own-video"])
      ) {
      ...
      ret.forEach(e => {
          ...
          for (let v of values) {
            newValues = newValues.concat(
              Object.values(v).filter(
                vv => vv && vv.constructor && t.test(vv.constructor.toString())
              )
            );
          }
          values = newValues;
        ...
        e.__gmgvIsPresentation = values.some(
          v => v && v.content && v.content === "sc"
        );
      });
      ...
      const hiddenSize = Array.from(screenCaptureModeLookup.values()).filter(
      ...
      if (settings["screen-capture-mode"]) {
        ...
        for (let i = 0; i < fullOrdering.length; i++) {
          if (fullOrdering[i]) {
            ...
            screenCaptureModeAllocations.set(
              fullOrdering[i].id,
              fullOrdering[i].order
            );
          } else {
            hiddenOffset++;
          }
        ...
        ret = ret.filter(v => {
          ...
          for (
            let dedupeID = 0;
            dedupeID <= screenCaptureModeLookup.size;
            dedupeID++
          ) {
          ...
          if (v && typeof v === "object") {
            for (let vv of Object.values(v)) {
              if (
                ...
                vv.length > 3 &&
                vv[0] === a[magicKey].id &&
                vv[2].includes("googleusercontent.com")
              ) {
                vv[1] = name;
              }
            }
      ...
      const setVideoQuality = magicSet(
        settings["screen-capture-mode"] ? 0 : size.height >= 200 ? 2 : 1
      );
      ...
      if (container) {
        ...
        if (settings["screen-capture-mode"]) {
          cols = rows = Math.ceil(
            Math.sqrt(screenCaptureModeLookup.size - hiddenSize)
          );
          const mul = Math.floor(
            Math.min(
              (innerWidth - 327) / (cols * 16),
              (innerHeight - 140) / (cols * 9)
            )
          );
          container.style.marginLeft = `${innerWidth -
            325 -
            mul * cols * 16}px`;
        ...
        container.classList.toggle(
          "__gmgv-screen-capture-mode",
          settings["screen-capture-mode"]
        );
        container.style.gridTemplateColumns = `repeat(${cols}, 1fr)`;
        container.style.gridTemplateRows = settings["screen-capture-mode"]
          ? `repeat(${rows}, 1fr)`
          : "";
          ...
          for (let t of divTests) {
            ...
            for (let v of values) {
              newValues = newValues.concat(
                Object.values(v).filter(
                  vv =>
                    vv && vv.constructor && t.test(vv.constructor.toString())
                )
              );
            }
            values = newValues;
        ...
        for (let i = 0; i < ret.length; i++) {
          const v = (lastStyles[i] = {
            el: children[i],
            name: ret[i][magicKey].name
          });
          if (settings["screen-capture-mode"]) {
    ...
    function injectShowHideButton(el, parent) {
      ...
      <div class="${refButton.classList}">
        <span class="${refButton.children[1].classList}">
          <svg viewBox="0 0 24 24">${
            hidden ? visibilityOff : visibilityOn
          }</svg>
        </span>
      ...
      b._refresh = () => {
        const hidden = hiddenIDs.has(id);
        b.querySelector(".__gmgv-show-hide > div > div").innerHTML = hidden
          ? T("showParticipant")
          : T("hideParticipant");
        b.querySelector("svg").innerHTML = hidden
          ? visibilityOff
          : visibilityOn;
      };
    ...
    function updateSetting(name, value) {
      ...
      // Update the menu CSS
      if (toggleButton) {
        toggleButton.querySelector("svg").innerHTML = settings["enabled"]
          ? gridOn
          : gridOff;
        const i = toggleButton.querySelector(
          `input[data-gmgv-setting="${name}"]`
        );
        if (i) i.checked = value;

        const showOnlyVideo = toggleButton.querySelector(
          'input[data-gmgv-setting="show-only-video"]'
        );
        showOnlyVideo.checked =
          settings["show-only-video"] && !settings["screen-capture-mode"];
        showOnlyVideo.disabled = settings["screen-capture-mode"];
        showOnlyVideo.parentElement.classList.toggle(
          "disabled",
          settings["screen-capture-mode"]
        );

        const highlightSpeaker = toggleButton.querySelector(
          'input[data-gmgv-setting="highlight-speaker"]'
        );
        highlightSpeaker.checked =
          settings["highlight-speaker"] && !settings["screen-capture-mode"];
        highlightSpeaker.disabled = settings["screen-capture-mode"];
        highlightSpeaker.parentElement.classList.toggle(
          "disabled",
          settings["screen-capture-mode"]
        );
      }
      ...
      if (container) {
        ...
        container.classList.toggle(
          "__gmgv-btb-resize",
          settings["bottom-toolbar"] === "resize"
        );
        container.classList.toggle(
          "__gmgv-btb-force",
          settings["bottom-toolbar"] === "force"
        );
        container.classList.toggle(
          "__gmgv-rtb-resize",
          settings["right-toolbar"] === "resize"
        );
        container.classList.toggle(
          "__gmgv-flip-self",
          settings["own-video"] === "flip"
        );
        if (!settings["enabled"]) {
          container.style.marginLeft = "";
          container.style.marginTop = "";
        ...
        const bottomBar = Array.from(
          container.parentElement.parentElement.children
        ).find(el => el.clientHeight === 88);
        bottomBar.style.transform =
          settings["enabled"] && settings["bottom-toolbar"] === "force"
            ? "translateY(0)"
            : "";
      }
      ...
      // Update settings CSS
      if (settingsOverlay) {
        settingsOverlay.style.display = settings["show-settings-overlay"]
          ? "flex"
          : "";
      }
